...
export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:~/bin/dart-sdk/bin:/home/alexeynabrodov/.nvm/versions/node/v9.10.1/bin/:$GOPATH/bin:~/.local/bin:/usr/local/go/bin:/media/vault/stash/bin
