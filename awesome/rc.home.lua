...
run_once("setxkbmap us,ru -option 'grp:ctrl_shift_toggle,caps:escape'")
run_once("gxkb")
...
ror = {
  ...
  ["n"]={"dolphin", "Dolphin"},
  ["v"]={"vivaldi-stable", "vivaldi-stable"},
  ["g"]={"telegram", "telegram"},
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey,         }, "Tab",
        function ()
            awful.util.spawn_with_shell('rofi -combi-modi window -show combi')
    ...
    awful.key({ altkey,         }, "F2",
        function ()
            awful.util.spawn_with_shell('rofi -combi-modi window,drun -show combi')
        end),
